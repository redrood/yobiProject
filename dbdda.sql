...
--
-- Host: localhost    Database: db1012368_dda
-- ------------------------------------------------------
...
INSERT INTO `activite` VALUES (2,'ACTIVITE 2 ',8,'BASSE','2016-04-27','2016-04-29',1),(7,'ACTIVITE 1',23,'HAUTE','2016-04-27','2016-04-29',1),(8,'ACTIVITE 3 ',24,'MOYENNE','2016-04-27','2016-04-30',1);
...
INSERT INTO `client` VALUES (1,'Huaweii','algere','c bon','salasld',2,18),(3,'kkhj','hj','hj','jhj',3,18),(4,'Policeee2','algerr','erere','DGSN1',2,NULL),(9,'1','2','4','3',NULL,NULL),(11,'Huaweii','algere','ccxccs','salasld',2,NULL),(12,'Huaweii','algere','ccxccs','salasld',2,NULL),(13,'dfghjk',';ertyuiop','fghjk','fgh',1,NULL),(14,'kkhj','algere',',,,,','salasld',1,NULL),(15,'Policeee','alger','aa','DGSN',2,NULL),(17,'Ministere de la Santé','aaaa','aaa','MSPRH',4,NULL),(18,'SNTR','JK ','K KJ K','K K ',3,8),(19,'dfghjk','fghjk','ghjk','fghj',1,18),(20,'fadadafsafsa','jkl','lhjk','l',1,18),(21,'AADL','aaaa','aaa','aaa',2,18),(22,'ANRH','DD','DDDD','DDD',3,13),(23,'DRAGON OIL','EEE','EEE','EEE',5,13),(24,'Cosider TP','jjj','kkkk','kkkkk',2,13),(25,'hkbk','nbk','jk','n;n',1,18),(26,'n','nbk','nn','n;n',1,18);
...
--
-- Table structure for table `contact_fournisseur`
--
...
--
-- Dumping data for table `contact_fournisseur`
--

LOCK TABLES `contact_fournisseur` WRITE;
/*!40000 ALTER TABLE `contact_fournisseur` DISABLE KEYS */;
INSERT INTO `contact_fournisseur` VALUES (2,2,'xqXQx','SQDd','jkhj@GMAIL.COM','hhhhh',4555555),(3,2,'med2','mod3','med4@gmail.com','alger83',55452228);
...
INSERT INTO `departement` VALUES (1,'DDA','Departement Developpement d\'affaires'),(2,'DOS','Departement Organisme Spécifique'),(3,'DE','Departement Entreprises'),(4,'DAP','Departement Administrations Publiques'),(5,'DEF','Departement Etablissements Financiers');
...
INSERT INTO `fonction` VALUES (0,'Directeur'),(1,'Chef du Departement Developpement d\'Affaire'),(2,'Ingenieur Avant-Vente'),(3,'Chef de Service Appel d\'Offre'),(4,'Chargé de Compte Hébergement Web'),(5,'Chargé de compte');
/*!40000 ALTER TABLE `fonction` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `formulaire_pdf`
--
...
--
-- Dumping data for table `formulaire_pdf`
--

LOCK TABLES `formulaire_pdf` WRITE;
/*!40000 ALTER TABLE `formulaire_pdf` DISABLE KEYS */;
INSERT INTO `formulaire_pdf` VALUES (152,'mohoooo','upload/Dy-marche.pdf'),(153,'nonon','upload/DemandeAdmission.pdf'),(154,'pmpmpm','upload/Dy-marche.pdf');
...
INSERT INTO `fournisseur` VALUES (2,'HUAWEI','hydra','rien'),(6,'CISCO','Bab Ezzouar',',nk,nk');
...
INSERT INTO `projet` VALUES (36,'DRAGON OIL - Devis routeur',23,15,'devis établie à la base dela demande du DE pour répondre à une consultation restreinte\r\n','01-02-2016','16-02-2016',1,'Routeur'),(38,'Cosider - WAN',24,9,'en cours de négocition vue que le client souhaite avoir une solution full Wimax \r\n','01-04-2016','24-04-2016',1,'Interconnexion WAN- solution hybride-\r\nInterconnexion WAN- solution hybride-\r\n'),(132,'aaaaa',24,16,'dfghj','05/31/2016','06/15/2016',0,NULL),(133,'aaaaa',24,16,'dfghj','05/31/2016','06/15/2016',0,NULL),(134,'aaaaazertt',20,17,'ksokao','06/07/2016','06/08/2016',0,NULL),(135,'aaaaazertt',20,17,'ksokao','06/07/2016','06/08/2016',0,NULL),(136,'fghjk',22,24,'fghjk;','06/07/2016','07/06/2016',0,NULL),(137,'fghjk',22,24,'fghjk;','06/07/2016','07/06/2016',0,NULL),(138,'popop',17,17,'kk,k','06/22/2016','06/08/2016',0,NULL),(139,'popop',17,17,'kk,k','06/22/2016','06/08/2016',0,NULL),(140,'kppppppp',15,20,'llk','06/09/2016','06/16/2016',0,NULL),(141,'kppppppp',15,20,'llk','06/09/2016','06/16/2016',0,NULL),(142,'iuoioio',18,19,'kjkj','06/08/2016','06/10/2016',0,NULL),(143,'iuoioio',18,19,'kjkj','06/08/2016','06/10/2016',0,NULL),(144,'iuoioio',18,19,'kjkj','06/08/2016','06/10/2016',0,NULL),(145,'iuoioio',18,19,'kjkj','06/08/2016','06/10/2016',0,NULL),(146,'loool',21,17,'kjkjk','06/16/2016','06/10/2016',0,NULL),(147,'11324',19,16,'jhjj','06/09/2016','06/16/2016',0,NULL),(148,'testooo',21,19,'fghjk','06/23/2016','06/08/2016',0,NULL),(149,'tasetoop',22,20,'ghjkl','06/23/2016','06/07/2016',0,NULL),(150,'pouop',21,18,'ghjkl:','06/01/2016','06/02/2016',0,NULL),(151,'aminoo',19,18,'fghjk','06/02/2016','06/29/2016',0,NULL),(152,'mohmoh',18,17,'ghjkl','06/08/2016','06/23/2016',0,NULL),(153,'wissem',12,18,'sdfghjk','06/08/2016','06/22/2016',0,NULL),(154,'mipa',18,16,'ertyui','06/01/2016','06/09/2016',0,NULL);
/*!40000 ALTER TABLE `projet` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `projet_fournisseur`
--
...
--
-- Dumping data for table `projet_fournisseur`
--

LOCK TABLES `projet_fournisseur` WRITE;
/*!40000 ALTER TABLE `projet_fournisseur` DISABLE KEYS */;
INSERT INTO `projet_fournisseur` VALUES (146,2),(148,2),(149,2),(150,2),(151,2),(152,2),(153,2),(154,2),(147,6);
/*!40000 ALTER TABLE `projet_fournisseur` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `projet_structure`
--
...
--
-- Dumping data for table `projet_structure`
--

LOCK TABLES `projet_structure` WRITE;
/*!40000 ALTER TABLE `projet_structure` DISABLE KEYS */;
/*!40000 ALTER TABLE `projet_structure` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `structure_technique`
--
...
--
-- Dumping data for table `structure_technique`
--

LOCK TABLES `structure_technique` WRITE;
/*!40000 ALTER TABLE `structure_technique` DISABLE KEYS */;
INSERT INTO `structure_technique` VALUES (1,'Reseau LAN WAN'),(2,'Wifi Wimax'),(3,'LTE'),(4,'4G');
/*!40000 ALTER TABLE `structure_technique` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tache_predifinie`
--
...
--
-- Dumping data for table `tache_predifinie`
--

LOCK TABLES `tache_predifinie` WRITE;
/*!40000 ALTER TABLE `tache_predifinie` DISABLE KEYS */;
INSERT INTO `tache_predifinie` VALUES (1,'rienrr'),(2,'Defintion des besoins'),(3,'ARRAAR'),(4,'sasa');
...
--
-- Dumping data for table `tache_projet`
--

LOCK TABLES `tache_projet` WRITE;
/*!40000 ALTER TABLE `tache_projet` DISABLE KEYS */;
INSERT INTO `tache_projet` VALUES (5,'haute',2,38,'12/12/12','12/12/12',1);
...
INSERT INTO `user` VALUES (8,'wissem','0Wissem','205422004','wissem@gmail.com',2,'wissem','2016',2,1222,1581181,'12-11-13','12-01-11','CDI'),(9,'Bougheloum','Mohammed','0660770389','Bougheloum@algerietelecom.dz',2,'Mouh','0000000',1,151515,1581155,'12-11-13','12-05-13','CDI'),(11,'FELFOUL','Lynda','0660848943','felfoul@at.dz',2,'Lynda','0000',1,15151651,15811665,'12-11-13','12-11-13','CDI'),(13,'AFRIT','Siham','0660340349','siham.alem@algerietelecom.dz',2,'Siham','motdepasse',1,1615656,15814555,'12-11-13','12-05-16','CDI'),(15,'BELARBI','Rachda','0660378710','r_belarbi@algerietelecom.dz',2,'Rachda','1234',1,156565,15859441,'12-11-13','12-11-13','CDI'),(16,'DJENOURI','Mohamed Amine','0557984102','amine.djenouri@alegerietelecom.dz',2,'94','0000',1,6616161,4941181,'12-11-13','12-11-13','CDT'),(17,'ALLALI','Redha','0660824189','allali@algerietelecom.dz',1,'The_Boss','2015',1,6845454,18954121,'12-11-13','12-04-13','CDI'),(18,'DAOUD','Yacine',NULL,NULL,5,'yacine','0000',4,55222222,15145454,'02-10-15','12-11-13','CDI'),(19,'ABDMEZIANE','Abderrahmane','0660570005','a.abdmeziane@algerietelecom.dz',2,'Abdou','abdou',1,16151561,556564,'12-01-16','01-04-14','CDT'),(20,'TIDADINI','FOUZI LARBI','0660843702','TIDADINI@ALGERIETELECOM.DZ',2,'FOUZI','ADAMWASSIM',1,55456522,5154,'17-04-14','12-11-14','CDI'),(23,'fadi','fao','05547555','fado@gmail.com',2,'fadi','azerty',3,5155,7888,'22-12-14','22-05-14','CDI'),(24,'fadi','fao','05547555','fado@gmail.com',2,'fado','12346',3,55445555,584894854,'04-04-14','12-11-15','CDI'),(25,'mouniii','i','5243','i@gmail.com',2,'kjghj','1234565',5,5649464,65654546,'22-12-14','12-11-13','CDI'),(26,'eghjk','dfghj','54785','k@gmail.com',1,'fghj','hj',4,656565,5555555,'25-06-10','12-11-12','CDI'),(27,'jj','jjj','0222555565','jjjj@gmail.comc',1,'aaaaaaaaa','aaaaaaaaa',4,1555545,5845555,'14-11-12','12-11-11','CDI');
...
-- Dump completed on 2016-10-13 18:39:23
